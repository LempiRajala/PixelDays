...
export class MailProvider {
  ...
  postVerifyMail(to, name, host, lang, code) {
    ...
    const html = `<em>${t`Hello ${name}`}</em>,<br />
      ...
      ${t`Thanks`}<br /><br />
      <img alt="" src="https://pixeldays.xyz/tile.png" style="height:64px; width:64px" />`;
...
${t`If this was you, please ignore this email. If it wasn't you, please go to <a href="https://pixeldays.xyz">pixeldays.xyz</a> and log-out any session that you are unaware of under "Login Methods" in the User Area and change your password.`}<br />
${t`Thanks`}<br /><br />
<img alt="" src="https://pixeldays.xyz/tile.png" style="height:64px; width:64px" />`;
    this.sendMail(to, subject, html);
  }
