...
const Help = () => {
  ...
  return (
    <div className="content">
      ...
      <p style={{ paddingLeft: '10px' }}>2) We do not allow moderation to abuse its authority. For example, if a moderator is Russian or Ukrainian, they should not be more loyal to their own country than to players from other factions.</p>
      <p style={{ paddingLeft: '10px' }}>3) We listen to the players' opinions and try to implement their ideas and ambitions. You help us to become better!</p>
